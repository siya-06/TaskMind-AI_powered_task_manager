...
FAISS vector search
and LLM-powered contextual responses
...
For scalable icons throughout the dashboard and chat UI.
...
the task gets embedded into vector space
stored inside FAISS
indexed for semantic retrieval later
